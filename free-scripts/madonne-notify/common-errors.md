...
<summary>You lack the required entitlement to use MS_Madonne_Notify</summary>



This message indicates that you do not have permission to launch the MadonneNotify resource.
