...
* [Installation Guide](installation.md) - Get started with Madonne DOJ
* [Configuration](configuration/) - Configure the script for your server
* [Permissions System](configuration/permissions-system.md) - Understand and configure permissions
* [Internationalization](configuration/adding-a-new-language.md) - Add new languages to the interface
* [Usage Guide](usage.md) - Learn how to use the tablet interface
